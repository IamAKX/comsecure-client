...
public class FindBuddyService extends Service {
    LocationManager locationManager;
    LocationListener locationListener;
    FirebaseDatabase database = FirebaseDatabase.getInstance();
    DatabaseReference reference = database.getReference("findMyBuddy");
    ...
    public void onCreate() {
        ...
        Toast.makeText(getBaseContext(),"Find my buddy service starts", Toast.LENGTH_SHORT).show();
    ...
    public void onDestroy() {
        super.onDestroy();
        Toast.makeText(getBaseContext(),"FindBuddy service stopped", Toast.LENGTH_SHORT).show();
